          ...
          <div className="flex flex-col   w-full -mt-10">
            ...
            <div className="flex flex-col gap-7 items-center text-black  p-15 max-[1070px]:p-10">
                <div className="w-[88vw] flex max-[1200px]:flex-col max-[800px]:w-[100vw] gap-5 p-10 bg-gray-100 min-h-[600px] rounded-3xl">
                                <div className="flex max-[500px]:text-sm max-[1200px]:order-2 flex-col justify-start gap-5">
                ...
                <div className="flex flex-col gap-5 p-15">
                    ...
                    <div className="w-[88vw] flex flex-col gap-5 items-center justify-center  min-h-[300px] max-[800px]:w-[100vw] rounded-3xl bg-gray-200 p-5">
                                <ul className="list-disc max-[500px]:text-sm flex flex-col gap-3 p-5">
                ...
                <div className="flex flex-col items-center max-[1000px]:items-start ">
                    <p className="text-4xl max-[500px]:text-2xl  text-center">The program has five components to it:</p>
                    <div className="grid grid-cols-5 max-[800px]:-ml-15 gap-x-20 max-[800px]:grid-cols-1 max-[1070px]:gap-x-10 max-[1070px]:grid-cols-2 gap-y-10 items-center w-full text-white p-15 max-[1070px]:p-5 max-[800px]:p-5">
                        <div className="w-[15vw] max-[800px]:w-[100vw] max-[1070px]:w-[43vw] flex flex-col items-center justify-center bg-[#06896B] rounded-2xl text-center p-5 min-h-[200px]">
                            <p className="text-center font-semibold max-[500px]:text-sm">Providing digital literacy at the village doorstep</p>
                        </div>
                        <div className="w-[15vw] max-[800px]:w-screen max-[1070px]:w-[45vw] flex flex-col items-center justify-center bg-[#06896B] rounded-2xl  min-h-[200px]">
                            <p className="text-center font-semibold max-[500px]:text-sm">IT education</p>
                        </div>
                        <div className="w-[15vw] max-[800px]:w-screen max-[1070px]:w-[43vw] flex flex-col items-center justify-center p-10 bg-[#06896B] rounded-2xl min-h-[200px]">
                            <p className="text-center font-semibold max-[500px]:text-sm">Entrepreneurship development</p>
                        </div>
                        <div className="w-[15vw] max-[800px]:w-screen max-[1070px]:w-[45vw]  flex flex-col items-center justify-center p-10 bg-[#06896B] rounded-2xl h-[200px]">
                            <p className="text-center font-semibold max-[500px]:text-sm">Common public utility services.</p>
                        </div>
                        <div className="w-[15vw] max-[800px]:w-screen max-[1070px]:w-[43vw] flex flex-col items-center justify-center bg-[#06896B] rounded-2xl h-[200px]">
                            <p className="text-center font-semibold max-[500px]:text-sm">Dissemination of government policies and schemes</p>
                        </div>
                        
                    </div>
                </div>
                <div className="flex flex-col gap-5 items-center justify-center">
                    <p className="text-4xl max-[500px]:text-2xl text-center">The Key Objectives of the program are:</p>
                    <div className="flex max-[1000px]:flex-col max-[1000px]:gap-6 items-center p-5 gap-3 w-[80vw] max-[1000px]:w-[100vw]  bg-gray-200 min-h-[550px] rounded-2xl">
                            <div className=" flex flex-col justify-center items-center border border-8 border-black w-[40vw] max-[1000px]:w-[90vw] p-10 min-h-[400px]">
                                <ul className="flex flex-col items-start  text-xl gap-4 list-disc">
                                    <li className="max-[500px]:text-sm">Reducing the digital divide for those living in remote areas</li>
                                    <li className="max-[500px]:text-sm">Building awareness of computers as a window to knowledge</li>
                                    <li className="max-[500px]:text-sm">Creating linkages to government programs and initiatives</li>
                                    <li className="max-[500px]:text-sm">Enhancing interest levels in learning</li>
                                    <li className="max-[500px]:text-sm">Introducing a multidisciplinary approach to education</li>
                                </ul>
                            </div>
                            <div className=" flex flex-col justify-start max-[1000px]:justify-center items-center border border-8 border-black w-[40vw] max-[1000px]:w-[90vw] p-10 min-h-[400px]">
                                <ul className="flex flex-col items-start   text-xl gap-4 list-disc">
                                    <li className="max-[500px]:text-sm">Using computers as a tool for everyday tasks</li>
                                    <li className="max-[500px]:text-sm">Encouraging collaborative learning</li>
                                    <li className="max-[500px]:text-sm">Developing interpersonal skills</li>
                                    <li className="max-[500px]:text-sm">Spreading technology awareness across rural communities</li>
                                    <li className="max-[500px]:text-sm">Providing equal opportunities for rural youth</li>
                                </ul>
                            </div>
                    </div>
                </div>
                <div className="flex flex-col gap-30 max-[800px]:gap-20 p-5  items-center justify-center pt-20">
                    <p className="text-2xl font-medium text-center text-[#06896B] max-[500px]:text-2xl font-semibold">3DWEBSOFT Foundation follows a systematic process to bring the Future Tech School Program to villages:</p>
                    <div className="flex gap-8 max-[1000px]:flex-col max-[1000px]:gap-10 items-center justify-center bg-gray-200 min-w-screen p-5 min-h-[300px]">
                        <div className="flex flex-col max-[1000px]:order-2 gap-5 w-[55vw] max-[1000px]:w-[90vw]">
                            <p className="text-2xl font-semibold max-[500px]:text-2xl">1. Village Mapping and Community Engagement:</p>
                            <p className="max-[500px]:text-sm">As a first step, villages are identified and mapped. Regular meetings are held with school administrators and community members to raise awareness of the program and enrol students. Community-building and rapport-building activities are conducted on an ongoing basis.</p>
                        </div>
