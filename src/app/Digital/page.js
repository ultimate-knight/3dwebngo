    ...
    <div className="flex flex-col flex-1 gap-0 tracking-widest leading-loose  items-center overflow-x-hidden min-h-screen justify-center bg-white font-sans">
          ...
          <div className="flex flex-col gap-20  w-full -mt-10">
            ...
            <div className="absolute inset-0 z-10 flex flex-col items-center max-[887px]:mt-20 justify-center w-full rounded-lg bg-black/56  text-center text-white">
                  <p className="text-7xl font-extrabold max-[500px]:text-2xl">Digital Sparks Learning Station</p>
                </div>
            </div>
            <div className="p-20 -mt-20 max-[1000px]:p-10 max-[1000px]:-mt-0 max-[840px]:p-5 font-sans text-black">
              <div className="flex flex-col gap-10">
                <p className="text-3xl text-[#06896B] max-[500px]:text-2xl font-semibold">Digital Sparks Learning Station</p>
                <p className="max-[500px]:text-sm">The Digital Sparks Learning Station is 3DWEBSOFT Foundation's own concept for open, self-directed learning — built on the belief that children learn best when curiosity is allowed to lead. The Learning Station is based on a simple but powerful idea: give children in underserved communities free, unsupervised access to technology, and they will teach themselves, and each other, remarkable things.</p>
                <p className="max-[500px]:text-sm">The concept places an accessible computer or digital kiosk right in the heart of a community — in a school corridor, a community centre, or a shared public space — where children can walk up and explore freely, without fear or formal instruction. For many children living in urban slums and rural communities, this is their first ever window to computers and the internet, and it opens up a whole new world of possibility.</p>
                <p className="max-[500px]:text-sm">The idea rests on a truth we see again and again: children, regardless of their social or economic background, can benefit enormously from simple technology and self-learning when given regular access and opportunity. Such interventions go a long way toward bridging the digital divide. This approach does more than support basic education — it nurtures curiosity, confidence, and key life skills among children who are too often left out of the digital world.</p>
                <p className="max-[500px]:text-sm">By placing Digital Sparks kiosks in the middle of the community — in playgrounds, along boundary walls, in school corridors, or inside community buildings — the program's reach and impact can be experienced and witnessed by everyone. The initiative is designed to benefit in-school children, out-of-school children, adolescents, and adult community members alike.</p>
                <p className="max-[500px]:text-sm"> Through innovative digital technology and reliable connectivity, Digital Sparks aims to make computers and the internet accessible to those who need them most.</p>
              </div>
              <div className="flex  items-center max-[1000px]:flex-col gap-10 pt-10">
                  <div className="flex flex-col gap-7 max-[1000px]:order-2">
                    
                    <p className="text-2xl text-[#06896B] w-[45vw] max-[1000px]:w-[90vw] max-[1000px]:text-center max-[500px]:text-2xl uppercase font-bold">There are many benefits of the Digital Sparks Learning Station:</p>
                    <div className="flex flex-col max-[1000px]:order-2 items-center gap-4 p-10 w-[50vw] max-[1000px]:w-[100vw] min-h-[270px] bg-[#06896B]">
                            <ul className="text-white list-disc flex flex-col max-[500px]:text-sm gap-3">
                  ...
                  <p className="text-center max-[500px]:text-sm">Through the Digital Sparks Learning Station, 3DWEBSOFT Foundation gives children from rural areas, remote locations, and urban slums the chance to acquire computer literacy at their own pace — sparking a lifelong love of learning and helping bridge the digital divide, one child at a time.</p>
                  </div>
              </div>
              <div className="pt-20 flex flex-col gap-7 max-[1000px]:gap-15  items-center justify-center">
                <p className="text-3xl text-[#06896B] font-bold max-[500px]:text-2xl">This model of the Digital Sparks Learning Station is built on the following framework:</p>
                <div className="grid grid-cols-3 max-[1000px]:grid-cols-2 max-[840px]:grid-cols-1 gap-x-5 gap-y-7">
                  <div className="shadow-md justify-center shadow-gray-400 p-5 w-[27vw] max-[1000px]:w-[45vw] max-[840px]:w-[90vw] min-h-[250px] flex flex-col gap-4 items-center rounded-lg">
                    ...
                    <p className="text-center text-gray-500 max-[500px]:text-sm">Open, self-directed learning stations located in school grounds or shared community spaces</p>
                  </div>
                    <div className="shadow-md justify-center shadow-gray-400 p-5 w-[27vw] max-[1000px]:w-[45vw] max-[840px]:w-[90vw] min-h-[250px] flex flex-col gap-4 items-center rounded-lg">
                    <Check strokeWidth={4} size={50} className="text-[#06896B]"/>
                    <p className="text-center text-gray-500 max-[500px]:text-sm">Installed with rugged, easy-to-use hardware suited to diverse rural and urban settings</p>
                  </div>
                    <div className="shadow-md justify-center shadow-gray-400 p-5 w-[27vw] max-[1000px]:w-[45vw] max-[840px]:w-[90vw] min-h-[250px] flex flex-col gap-4 items-center rounded-lg">
                    <Check strokeWidth={4} size={50} className="text-[#06896B]"/>
                    <p className="text-center text-gray-500 max-[500px]:text-sm">Engaging educational games and content that invite children to learn through exploration</p>
                  </div>
                    <div className="shadow-md justify-center shadow-gray-400 p-5 w-[27vw] max-[1000px]:w-[45vw] max-[840px]:w-[90vw] min-h-[250px] flex flex-col gap-4 items-center rounded-lg">
                    <Check strokeWidth={4} size={50} className="text-[#06896B]"/>
                    <p className="text-center text-gray-500 max-[500px]:text-sm">Content mapped to the school curriculum to support better academic outcomes</p>
                  </div>
                    <div className="shadow-md justify-center shadow-gray-400 p-5 w-[27vw] max-[1000px]:w-[45vw] max-[840px]:w-[90vw] min-h-[250px] flex flex-col gap-4 items-center rounded-lg">
                    <Check strokeWidth={4} size={50} className="text-[#06896B]"/>
                    <p className="text-center text-gray-500 max-[500px]:text-sm">Children working in self-organised groups, helping one another gain functional computer literacy in a short span of time</p>
                  </div>
                    <div className="shadow-md justify-center shadow-gray-400 p-5 w-[27vw] max-[1000px]:w-[45vw] max-[840px]:w-[90vw] min-h-[250px] flex flex-col gap-4 items-center rounded-lg">
                    <Check strokeWidth={4} size={50} className="text-[#06896B]"/>
                    <p className="text-center text-gray-500 max-[500px]:text-sm">Growing interest in learning that generates positive feedback from teachers and the community</p>
                  </div>
                    <div className="shadow-md justify-center shadow-gray-400 p-5 w-[27vw] max-[1000px]:w-[45vw] max-[840px]:w-[90vw] min-h-[250px] flex flex-col gap-4 items-center rounded-lg">
                    <Check strokeWidth={4} size={50} className="text-[#06896B]"/>
                    <p className="text-center text-gray-500 max-[500px]:text-sm">Children from underprivileged communities in rural areas, remote locations, and slums acquiring computer skills largely on their own</p>
                  </div>
                </div>
              </div>
                  </div>
