    ...
    <div className="flex flex-col flex-1 leading-loose gap-0 tracking-widest  items-center overflow-x-hidden min-h-screen justify-center bg-white font-sans">
          ...
          <div className="flex flex-col   w-full -mt-10">
            ...
            <div className="absolute inset-0 z-10 flex flex-col max-[887px]:mt-20 items-center justify-center w-full rounded-lg bg-black/56  text-center text-white">
                  <p className="text-7xl font-extrabold max-[800px]:text-5xl max-[500px]:text-3xl">Skilling at 3DWEBSOFT Foundation</p>
                </div>
            </div>
            ...
            <div className="flex flex-col gap-7 text-black  p-15 max-[500px]:p-5">
                    <div className="flex gap-8 max-[1000px]:flex-col items-center">
                        ...
                        <p className="max-[500px]:text-sm">A large population of underprivileged youth and women across urban slums and rural communities in Karnataka lack or possess negligible vocational skills. This prevents them from taking advantage of the vast employment opportunities in India's cities. As a result, many young people remain unemployed or under-employed.</p>
                        <p className="max-[500px]:text-sm">Skills training is one of the most powerful tools for making a lasting impact on the lives of these young people and their families. Our aim is to make them self-reliant, bridge the gap between learning and earning, and instill confidence and dignity in every one of our students. Over 10 years of dedicated service, we have empowered 5,000+ beneficiaries and facilitated 1,200+ placements through 30+ community and skilling programs.</p>
                        </div>
                    <img src="/lagfer.jpeg" className="w-[400px] max-[1000px]:w-[100vw] max-[1000px]:order-1 h-auto"/>
                    </div>
                    <div className="flex flex-col gap-8">
                        <p className="max-[500px]:text-sm">3DWEBSOFT Foundation has various models through which skill training is provided to our beneficiaries.</p>
                        <ul className="flex flex-col max-[500px]:text-sm gap-8 list-disc pl-10 text-left w-[85vw]">
                    ...
                    <div className="flex flex-col gap-6 items-center justify-center w-full pt-10">
                        <p className="text-[#06896B] font-bold text-3xl tracking-widest max-[500px]:text-2xl">The Methodology followed across our centers include:</p>
                        <div className="w-[88vw] flex flex-col items-center justify-center p-20 min-h-[300px] rounded-lg bg-[#06896B]">
                            <div className="text-white flex text-left font-bold max-[500px]:text-sm  max-[500px]:min-w-[70vw] flex-col gap-6 list-disc ">
                    ...
                    <div className="flex gap-5 max-[1000px]:flex-col  items-center justify-center">
                        <div className="flex tracking-widest max-[1000px]:w-[85vw] max-[1000px]:order-2 leading-loose flex-col gap-4 w-[55vw]">
                            <p className="tracking-widest max-[500px]:text-sm">3DWEBSOFT Foundation has a range of career and skill-focused courses to choose from. Some of these include Computer Training / Office Automation, Web Designing, Full Stack Development, Digital Literacy, Tailoring & Self-Employment, Beauty Parlour Training, and Handicrafts & Home Business Support.</p>
                            <p className="tracking-widest max-[500px]:text-sm">3DWEBSOFT Foundation prepares students to build careers and assists them with placements. For this, job drives, campus placement fairs, on-the-spot interviews, mock interviews, counseling, and regular follow-ups take place. Through our employer tie-ups, we connect our students directly with hiring partners to open pathways to employment.</p>
                        </div>
                    ...
                    <div className="flex flex-col items-start gap-3 max-[1000px]:p-1 pt-10 p-10">
                                    <p className="font-semibold max-[500px]:text-xl">Skilling Going Virtual:</p>
                                    <p className="max-[500px]:text-sm">To ensure that learning can take place anytime and anywhere, 3DWEBSOFT Foundation is extending digital literacy and skill training into rural areas through accessible, hands-on programs that bridge the digital divide. As we move forward, a hybrid model is developing where students have access to both center facilities and online sessions — enabling us to continue our mission of creating deep impact across communities.</p>
                                    <p className="max-[500px]:text-sm">Today, the Key Features that make Skilling Programs at 3DWEBSOFT Foundation Stand Out:</p>
                                    <ul className="flex flex-col max-[500px]:text-sm gap-2 list-disc p-5 w-[60vw] max-[1000px]:w-[90vw]">
                                        <li><span className="text-black font-bold">5,000+ Beneficiaries</span> — youth and women empowered through our training programs</li>
                                        <li><span className="text-black font-bold">1,200+ Placements</span> — successful job placements facilitated for community members</li>
                                        <li><span className="text-black font-bold">10 Years of Experience</span> — dedicated service supporting underprivileged groups</li>
                                        <li><span className="text-black font-bold">30+ Programs</span> — community, skilling, and awareness programs conducted annually</li>
                                        <li><span className="text-black font-bold">Certified & Scalable</span> — industry-aligned certified courses on a replicable model for quick deployment in any urban, semi-urban, or rural location</li>
                                    </ul>
                    </div>
